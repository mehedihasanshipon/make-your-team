              ...
              <img src= {image} className="img-fluid" alt="" />
                <div className="player-body">
                  <ul className="list-group list-group-flush">
                    ...
                    <li className="list-group-item">Salary : <span className ="b">{salary}</span></li>
                  ...
                  <div className = "text-center pt-3 ">
                    <button  onClick = {() => handleAddClick(props.player)} className="btn btn-danger button "><FontAwesomeIcon icon={faUserPlus} /><span className = "text-center"> Add Now</span></button>
                  </div>
              </div>
          </div>
    </div>
